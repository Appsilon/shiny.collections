**This package is DEPRECATED and no longer supported. The reason are problems with `drainConnection` and lack of further support for [rethinker](https://github.com/mbq/rethinker)**
